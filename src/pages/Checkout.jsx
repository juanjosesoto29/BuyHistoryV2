...
export default function Checkout() {
  ...
  const onSubmit = (e) => {
    ...
    if (!form.nombre.trim() || !form.apellidos.trim() || !form.correo.trim()
        || !form.calle.trim() || !form.comuna.trim()) {
  ...
  return (
    <div className="shop-page">
      <div className="checkout-wrap">
        ...
        <div className="checkout-card card border-0 section-gap">
          <div className="card-body">
            ...
            <form className="mt-3" onSubmit={onSubmit}>
              <div className="row g-3">
                <div className="col-12 col-md-6">
                  ...
                  <input className="form-control ck-input" placeholder=""
                ...
                <div className="col-12">
                  ...
                  <input type="email" className="form-control ck-input" placeholder=""
                    value={form.correo} onChange={e=>setForm({...form, correo:e.target.value})} required />
                </div>
              </div>

              {/* === Dirección === */}
              <div className="ck-title mt-4 mb-1">Dirección de entrega de los productos</div>
              ...
              <div className="row g-3 mt-1">
                <div className="col-12 col-md-8">
                  ...
                  <input className="form-control ck-input" placeholder=""
                    value={form.calle} onChange={e=>setForm({...form, calle:e.target.value})} required />
                </div>
                <div className="col-12 col-md-4">
                  <label className="form-label">Departamento (opcional)</label>
                  <input className="form-control ck-input" placeholder="Ej: 603"
                    value={form.depto} onChange={e=>setForm({...form, depto:e.target.value})} />
                </div>

                <div className="col-12 col-md-6">
                  <label className="form-label">Región*</label>
                  <select className="form-select ck-select" value={form.region}
                    onChange={e=>{
                ...
                <div className="col-12 col-md-6">
                  ...
                  <select className="form-select ck-select" value={form.comuna}
                    onChange={e=>setForm({...form, comuna:e.target.value})} required>
                ...
                <div className="col-12">
                  ...
                  <textarea className="form-control ck-textarea" rows="3"
